        ...
        <div className="bg-[#E4E7E9] rounded-lg p-6 flex flex-col md:flex-row items-center justify-between gap-6 mb-10">
          ...
          <form className="flex flex-col md:flex-row w-full md:w-auto gap-4">
            <input
              ...
              className="md:rounded-l-md border-[1.6px] border-solid border-[#101828] px-5 py-3 flex-grow md:flex-grow-0 focus:outline-none focus:ring-2 focus:ring-teal-400"
            />
            <button
              type="submit"
